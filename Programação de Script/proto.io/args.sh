...
#TODO Função para verificar se diretório existe
#TODO Colocar o IF da senha no lugar correto para não criar linha em vão
...
then
	...
	echo "Senha: $senha"
#else
	#echo "$1:$senha | chpasswd #Usa o comando chpasswd para mudar o password
fi
...
#Adicionar linha referente a senha
#echo $user"::$days:0:99999:7:::" >> /etc/shadow
